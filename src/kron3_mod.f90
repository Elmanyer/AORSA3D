    ...
    subroutine kron3( ny1, ny2, ny3, nx1,nx2,nx3, &
        ...
        do iy2=1,ny2
            ...
            if (use_gemm) then
                ...
                call zgemm( 'N','N', mm,nn,kk, alpha, Xin, ld1, A_t, ld2, beta, Yout, ld3 )

                !de b ug-begin
                if (idebug.ge.2) then
                    allocate( Youtb(1:ny1,1:ny3) )

                    Youtb(1:ny1,1:ny3) = matmul( Xin(1:ny1,1:nx3), A_t(1:nx3,1:ny3) )
                ...
                Yout(1:ny1,1:ny3) = matmul( Xin(1:ny1,1:nx3), A_t(1:nx3,1:ny3) )
            endif
            !        ----------------------------------------
